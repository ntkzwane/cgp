...
private:
     ...
     * @todo parts of Scene::genVizRender to be completed for CGP Assignment3
     */
     ...
     * @todo Scene::voxSetOp to be completed for CGP Assignment3
     */
     ...
     * @todo Scene::voxWalk to be completed for CGP Assignment3
     */
    void voxWalk(SceneNode *root, VoxelVolume *voxels);

    /**
     * Walk CSG tree and deallocate nodes.
     * Helper method for Scene::clear() method
...
public:
    ...
    /**
     * Reset CSG tree
     * @todo Parts of Scene::clear to be completed for CGP Assignment3
     */
    void clear();
