...
public:
     ...
     * @todo VoxelVolume::fill to be completed for CGP Assignment3
     */
     ...
     * @param dimx, dimy, dimz     number of voxels in x, y, z dimensions
     * @todo VoxelVolume::setDim to be completed for CGP Assignment3
     */
     ...
     * @todo VoxelVolume::set to be completed for CGP Assignment3
     */
     ...
     * @todo VoxelVolume::get to be completed for CGP Assignment3
     */
